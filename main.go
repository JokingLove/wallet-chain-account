...
import (
	...
	"github.com/JokingLove/wallet-chain-account/chaindispatcher"
	"github.com/JokingLove/wallet-chain-account/config"
	wallet2 "github.com/JokingLove/wallet-chain-account/rpc/account"
...
func main() {
	var f = flag.String("c", "config.yaml", "config path")
	flag.Parse()
